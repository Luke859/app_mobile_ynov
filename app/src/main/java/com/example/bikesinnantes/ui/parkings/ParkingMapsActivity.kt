...
import com.example.bikesinnantes.databinding.ActivityParkingMapsBinding
import com.example.bikesinnantes.model.*
                ...
                for(parkingSt in it) {
                    ...
                    if(parkingSt.id == parkingSelected!!.id){
                        ...
                        mMap.addMarker(
                            ...
                            .title(parkingSt.grpNom + " " + parkingSt.showDetails())
                            .icon(BitmapFromVector(this, R.drawable.ic_baseline_directions_bike_24)))
                    } else {
                        mMap.addMarker(MarkerOptions()
                            .position(parkingLatLng)
                            .title(parkingSt.grpNom + " " + parking.showDetails()))
                    }
                }
            }
